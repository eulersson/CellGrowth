...
QT_MOC_LITERAL(1, 9, 11), // "renderLater"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 9) // "renderNow"

    },
    "Viewport\0renderLater\0\0renderNow"
};
...
const QMetaObject Viewport::staticMetaObject = {
    { &QWindow::staticMetaObject, qt_meta_stringdata_Viewport.data,
...
void *Viewport::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QOpenGLFunctions"))
        return static_cast< QOpenGLFunctions*>(const_cast< Viewport*>(this));
