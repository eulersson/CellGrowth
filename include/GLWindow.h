...
private:
  //////////////////////////////////////////////////////////////////////////////
  /// @brief Cleans up all the textures and FBOs
  //////////////////////////////////////////////////////////////////////////////
  void cleanup();
...
private:
  ...
  // ===========================================================================
  //////////////////////////////////////////////////////////////////////////////
  /// @brief Float for the red ambient colour variable for the light.
  //////////////////////////////////////////////////////////////////////////////
  float m_lightAmbientR;

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Float for the green ambient colour variable for the light.
  //////////////////////////////////////////////////////////////////////////////
  float m_lightAmbientG;


  //////////////////////////////////////////////////////////////////////////////
  /// @brief Float for the blue ambient colour variable for the light.
  //////////////////////////////////////////////////////////////////////////////
  float m_lightAmbientB;

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Float for the red specular colour variable for the light.
  //////////////////////////////////////////////////////////////////////////////
  float m_lightSpecularR;

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Float for the green specular colour variable for the light.
  //////////////////////////////////////////////////////////////////////////////
  float m_lightSpecularG;

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Float for the blue specular colour variable for the light.
  //////////////////////////////////////////////////////////////////////////////
  float m_lightSpecularB;

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Float for FillLight ambient, specular, diffuse.
  //////////////////////////////////////////////////////////////////////////////
  float m_fillLight;
  ...
  //////////////////////////////////////////////////////////////////////////////
  /// @brief float to hold radius used in SSAO.
  //////////////////////////////////////////////////////////////////////////////
  float m_ssaoRadius;
  ...
  //////////////////////////////////////////////////////////////////////////////
  /// @brief Index for RenderPass subroutine that draws new order art style.
  //////////////////////////////////////////////////////////////////////////////
  GLuint m_NewOrderIndex;
...
public slots:
  ...
  //////////////////////////////////////////////////////////////////////////////
  /// \brief setLightIconScale
  /// \param _value
  //////////////////////////////////////////////////////////////////////////////
  void setLightIconScale(int _value);

  //////////////////////////////////////////////////////////////////////////////
  /// \brief setBackgroundBlurIterations
  /// \param _value
  //////////////////////////////////////////////////////////////////////////////
  void setBackgroundBlurIterations(int _value);

  //////////////////////////////////////////////////////////////////////////////
  /// \brief setBackgroundSkymap
  /// \param _index
  //////////////////////////////////////////////////////////////////////////////
  ...
  //////////////////////////////////////////////////////////////////////////////
  /// @brief Slot for changing ssao radius.
  /// @param[in] _radius Size of ssao radius.
  //////////////////////////////////////////////////////////////////////////////
  void setSSAORadius(double _radius);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Slot for changing bias value.
  /// @param[in] _bias Value of ssao bias
  //////////////////////////////////////////////////////////////////////////////
  void setSSAOBias(double _bias);
  ...
  //////////////////////////////////////////////////////////////////////////////
  /// \brief cancel Not implemented yet.
  //////////////////////////////////////////////////////////////////////////////
  void cancel();
  ...
  //////////////////////////////////////////////////////////////////////////////
  /// @brief Slot for changing the red value of the ambient impact from the light.
  /// @param[in] _red value.
  //////////////////////////////////////////////////////////////////////////////
  void setAmbientLightR(int _red);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Slot for changing the green value of the ambient impact from the light.
  /// @param[in] _green value.
  //////////////////////////////////////////////////////////////////////////////
  void setAmbientLightG(int _green);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Slot for changing the blue value of the ambient impact from the light.
  /// @param[in] _blue value.
  //////////////////////////////////////////////////////////////////////////////
  void setAmbientLightB(int _blue);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Slot for changing the specular red channel.
  /// @param[in] _red value.
  //////////////////////////////////////////////////////////////////////////////
  void setSpecularLightR(int _red);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Slot for changing the specular green channel.
  /// @param[in] _green value.
  //////////////////////////////////////////////////////////////////////////////
  void setSpecularLightG(int _green);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Slot for changing the specular blue channel.
  /// @param[in] _blue value.
  //////////////////////////////////////////////////////////////////////////////
  void setSpecularLightB(int _blue);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Slot for changing the overall impact og the fill light.
  /// @param[in] _amount percentage of light impacting the scene.
  //////////////////////////////////////////////////////////////////////////////
  void setFillLight (int _amount);
...
signals:
  ...
  //////////////////////////////////////////////////////////////////////////////
  /// @brief Singal emits when program is reset. The Radius will be set to
  /// default of 5.0f.
  /// @param[in] radius Radius of AO Particles.
  //////////////////////////////////////////////////////////////////////////////
  void resetAORadius(double radius);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Singal emits when program is reset. The Bias will be set to
  /// default of 0.025f.
  /// @param[in] value Value of bias.
  //////////////////////////////////////////////////////////////////////////////
  void resetAOBias(double bias);
  ...
  //////////////////////////////////////////////////////////////////////////////
  /// @brief Singal emits when red light value needs to be reset
  /// @param[in] default value of red.
  //////////////////////////////////////////////////////////////////////////////
  void resetRColour(int _value);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Singal emits when green light value needs to be reset
  /// @param[in] default value of green.
  //////////////////////////////////////////////////////////////////////////////
  void resetGColour(int _value);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Singal emits when blue light value needs to be reset.
  /// @param[in] default value of blue.
  //////////////////////////////////////////////////////////////////////////////
  void resetBColour(int _value);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Singal emits when red material value needs to be reset
  /// @param[in] default value of red.
  //////////////////////////////////////////////////////////////////////////////
  void resetRMaterialColor(int _value);


  //////////////////////////////////////////////////////////////////////////////
  /// @brief Singal emits when green material value needs to be reset
  /// @param[in] default value of green.
  //////////////////////////////////////////////////////////////////////////////
  void resetGMaterialColor(int _value);


  //////////////////////////////////////////////////////////////////////////////
  /// @brief Singal emits when blue material value needs to be reset.
  /// @param[in] default value of blue.
  //////////////////////////////////////////////////////////////////////////////
  void resetBMaterialColor(int _value);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Singal emits when program is reset. Resets to default value.
  /// @param[in] default value of red channel in ambient light.
  //////////////////////////////////////////////////////////////////////////////
  void resetAmbientLightR(int _red);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Singal emits when program is reset. Resets to default value.
  /// @param[in] default value of red channel in ambient light.
  //////////////////////////////////////////////////////////////////////////////
  void resetAmbientLightG(int _green);
  ...
  /// @param[in] default value of red channel in ambient light.
  //////////////////////////////////////////////////////////////////////////////
  void resetAmbientLightB(int _blue);


  //////////////////////////////////////////////////////////////////////////////
  /// @brief Singal emits when program is reset. Resets to default value.
  /// @param[in] _red value for the specular red channel.
  //////////////////////////////////////////////////////////////////////////////
  void resetSpecularLightR(int _red);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Singal emits when program is reset. Resets to default value.
  /// @param[in] _green value for the specular green channel.
  //////////////////////////////////////////////////////////////////////////////
  void resetSpecularLightG(int _green);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Singal emits when program is reset. Resets to default value.
  /// @param[in] _blue value for the specular blue channel.
  //////////////////////////////////////////////////////////////////////////////
  void resetSpecularLightB(int _blue);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief Singal emits when program is reset. Resets to default value.
  /// @param[in] default amount of fill light.
  //////////////////////////////////////////////////////////////////////////////
  void resetFillLight(int _amount);
  ...
  //////////////////////////////////////////////////////////////////////////////
  /// \brief enableSplitType Enables the split type.
